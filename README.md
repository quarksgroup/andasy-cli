...
```sh
curl -L https://github.com/quarksgroup/drop-cli/releases/download/v0.1.3/dropctl-linux-amd64.tar.gz \
  | tar xz
```
...
```sh
curl -L https://github.com/quarksgroup/drop-cli/releases/download/v0.1.3/dropctl-darwin-amd64.tar.gz \
  | tar xz
```
...
```powershell
Invoke-WebRequest -Uri "https://github.com/quarksgroup/drop-cli/releases/download/v0.1.3/dropctl-windows-amd64.zip" -OutFile "droptcl.zip"
```
