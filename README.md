...
```sh
curl -L https://github.com/quarksgroup/andasy-cli/releases/download/v0.2.17/andasy-linux-amd64.tar.gz \
  | tar xz
```
...
```sh
curl -L https://github.com/quarksgroup/andasy-cli/releases/download/v0.2.17/andasy-darwin-amd64.tar.gz \
  | tar xz
```
...
```powershell
Invoke-WebRequest -Uri "https://github.com/quarksgroup/andasy-cli/releases/download/v0.2.17/andasy-windows-amd64.zip" -OutFile "andasy.zip"
```
